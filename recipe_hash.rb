...
perfect_10_recipe = {"almond flour" => [2 "cups"] , "gluten freewhole oats"=> [1 "cup"] , "kosher salt" => [1/2 "tea spoon"] , "baking powder" => [1/2 "tea spoon"], "Xanthan gum"=> [1/2 "tea spoon"] , "silvered almonds, lightly toasted" => [1/4 "cup"] , "mini dark chocolate chips" => [3/4 "cup"] , "olive oil" => "1?2 cup" => [1/2 "cup"], "agave" => [1/4 "cup"]}
...
def amount_of_chocolate_chips(perfect_10_recipe)
  puts perfect_10_recipe[:mint_chocolate_chip]
end 
